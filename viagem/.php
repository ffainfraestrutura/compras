<?php
session_start();
include "./conecta.php"; // Verifique o caminho correto do seu arquivo de conex�o

if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Verifica se foi enviado o valor do aceite (1 para Sim, 0 para N�o)
...
// Redireciona de volta para a p�gina de solicita��es de viagem
