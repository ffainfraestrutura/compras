...
// if ($tipo_enquete == null) {
//   echo "<script language='javascript' type='text/javascript'>alert('Motivo Cadastrado com Sucesso');window.location=\"telainicialcoordenador.php\"</script>";
// }
...
// if ($tipo_enquete == 4) {
//   $link = './historicodesolicitacao.php';
// } elseif ($tipo_enquete == 1) {
//   $link = './historicodesolicitacao.php';
// } elseif ($tipo_enquete == 2) {
//   $link = './historicodesolicitacao.php';
// } elseif ($tipo_enquete == 3) {
//   $link = './historicodesolicitacao.php';
// }
?>
<!DOCTYPE html>
...
<body class="sb-nav-fixed">
        ...
        <main style="width: 100%;" class="mb-2">
            <div class="container-fluid px-4 col-sm-12">
                ...
                <div class="m-auto col-9">
                    <form method="post" action="./control/questionario.php">
                 ...
                 <div class='mt-3 row justify-content-start'>
                  ...
                  <div class='mt-3 row justify-content-start'>"; ?>
                                    ...
                                    <div class='col-sm-6'>
                                        ...
                                        <div class='col-sm-6'>
                                            <label class='mb-0 form-label' for='periodo_ida'>
                                                Período ida:<span style='color:red;'>*</span>
                                            </label>
                                            <select class='form-select' name='periodo_ida' id='periodo_ida' required
                                                onchange="verifica(this.value)">
                                                <option value="">Selecione...</option>
                                                <?php
                                            $sqlPeriodo = "SELECT idperiodo, periodo 
                                ...
                                <div class='col-sm-6'>
                                    ...
                                    <div>
                                        ...
                                        <textarea name="motivo_obs" class="border border-black p-1 rounded-md"
                                            id="motivo_obs" cols="70" rows="3" maxlength="255"
                                            placeholder="Por favor, insira uma Justificativa referente ao motivo da viagem."
                                            oninput="validarEntrada(this)"></textarea>
    ...
    <script>
        ...
        function mostrarCamposAdiantamento() {
            ...
            // Obtém o elemento dos campos adicionais
        ...
        // Função para bloquear ou habilitar o campo de valor_adiantamento
        function blockAdiantamento() {
            var adiantamentoSelect = document.getElementById('adiantamento');
            var valorAdiantamento = document.getElementById('valor_adiantamento');

            // Verifica o valor selecionado no campo "adiantamento"
            if (adiantamentoSelect.value == '0') {
                valorAdiantamento.disabled = true; // Desabilita o campo
                valorAdiantamento.value = ''; // Limpa o campo
            } else if (adiantamentoSelect.value == '1') {
                valorAdiantamento.disabled = false; // Habilita o campo
            }
        }

        // Adiciona o evento de mudança no campo "adiantamento"
        document.getElementById('adiantamento').addEventListener('change', blockAdiantamento);

        // Chama a função inicialmente para garantir o estado correto do campo
        window.onload = blockAdiantamento;
