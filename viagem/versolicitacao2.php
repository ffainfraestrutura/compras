...
AND me.idtbsolviagem IS NULL";
                            ...
                            while ($row = mysqli_fetch_array($resultado, MYSQLI_BOTH)) {
                                ...
                                echo "<tr class='$highlightClass'>
                                        ...
                                        <td><button type='button' class='btn btn-sm btn-primary' data-bs-toggle='modal' data-bs-target='#modalConcluir$id'>Editar</button></td>
                                        <td><button type='button' class='btn btn-sm btn-danger' data-bs-toggle='modal' data-bs-target='#modalExcluir$id'>Excluir</button></td>
                                      </tr>";
