...
WHERE 1=1";
                            ...
                            // Filtro de matrícula - Garantir que todas as combinações sejam incluídas
                            if (!empty($matricula1)) {
                                $sql .= " AND ( sv.matsolicitante = '$matricula1' 
                                             OR s.matricula = '$matricula1' 
                                             OR c.matricula = '$matricula1' 
                                             OR (g.matricula IN ('001938', '550016', '000052', '004783','550130') AND d.idtbdiretor IS NOT NULL) 
                            ...
                            while ($row = mysqli_fetch_array($resultado, MYSQLI_BOTH)) {
                                ...
                                if (!empty($row['idtbmotivo_exclusao'])) {
                                    ...
                                    switch ($row['aceite_do_diretor']) {
                                        ...
                                        case 1:
                                            if ($aceite_gegeral === 3) {
                                                $status = 'Aprovado pelo Gerente Geral';
                                            } else {
