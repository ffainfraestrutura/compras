            ...
            <table id='tabela1' class='table table-striped'>
              ...
              <tbody>
                ...
                $sql = "SELECT DISTINCT 
                              ...
                              fc.ccusto
                          FROM bdcorp.tbfuncionario fc
                          LEFT JOIN bdcorp.tbcolabcoord cc 
                              ON fc.matricula = cc.matrcolab
                          LEFT JOIN bdcorp.tbcoord c 
                              ON cc.matrcoord = c.matricula
                          ...
                          WHERE fc.status <> 'Demitido'
                            AND (fc.matricula <> '289293' OR fc.matricula = '$matricula1')  -- Garantindo a inclusão da matrícula '500146'
                          ORDER BY fc.nome";
