...
if ($usuariof === null || $usuariof !== '000023') {
    ...
    <div id="layoutSidenav_content">
        <main style="width: 100%;" class="mb-2">
            <div class="container-fluid px-4 col-sm-12">
                <h1 class="h1 pt-3 pb-2 col-12 text-center">Emails enviados pelo DP</h1>
...
LEFT JOIN bdcorp.tbdiretor d ON d.idtbdiretor = g.idtbdiretor
                                        ...
                                        AND sv.alimentacao_finalizada = '1'";
                  ...
                  <div class='modal fade' id='modalConcluido$id' tabindex='-1' aria-labelledby='exampleModalLabel' aria-hidden='true' enctype='multipart/form-data'>
                     <div class='modal-dialog modal-dialog-centered'>
                        <div class='modal-content'>
                          <div class='modal-header'>
                          <h5 class='modal-title' id='modalDetalhesLabel$id'>Alimentação de viagem</h5>
                          <button type='button' class='btn-sm btn-close' data-bs-dismiss='modal' aria-label='Fechar'></button>
                          </div>
                          <div class='modal-body' style='font-size: 13px;'>
                          <h6>Foi concluido o pagamento da Alimentação dessa viagem?</h6>
                          </div>
                        <div class='modal-footer'>
                       <form method='post' action='./control/alimentacao_finalizada.php'>
                            <input type='hidden' name='idtbsolviagem' value='$id'>
                            <button type='submit' class='btn btn-success' name='alimentacao_finalizada' value='2'>Sim</button>
                        </form>
                            <button type='button' class='btn btn-secondary' data-bs-dismiss='modal'>Fechar</button>
                        </div>
                      </div>
