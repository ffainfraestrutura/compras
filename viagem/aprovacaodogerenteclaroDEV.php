...
WHERE ( sv.matsolicitante IN ('001938', '000052','104854') 
        OR s.matricula IN ('001938', '000052','104854')
        OR c.matricula IN ('001938', '000052','104854')
        OR (g.matricula IN ('001938', '000052','104854') AND d.idtbdiretor IS NOT NULL) 
        OR d.matricula IN ('001938', '000052','104854'))
   AND sv.aceite_do_diretor IS NULL";
                            ...
                            while ($row = mysqli_fetch_array($resultado, MYSQLI_BOTH)) {
                                ...
                                $aceiteDiretor = "<td>
                                        <form method='post' action='./control/atualizar_aceiteCoord.php' id='formAceite$id'>
                                ...
                                echo "<div class='modal fade' id='modalDetalhes$id' tabindex='-1' aria-labelledby='modalDetalhesLabel$id' aria-hidden='true'>
                                        <div class='modal-dialog modal-dialog-centered'>
                                            <div class='modal-content'>
                                                ...
                                                <div class='modal-body' style='font-size: 13px;'>
                                                    ...
                                                    <p><strong>Cargo de Solicitante:</strong> $cargo_sol</p>
                                                    <hr>
                                    ...
                                    <div class='modal-dialog modal-dialog-centered'>
                                        <div class='modal-content'>
                                            ...
                                            <div class='modal-body' style='font-size: 13px;'>
                                                <form action='./control/modal/processa_AdiantamentoCoord.php' method='POST'>
                                            ...
                                            <div class='modal-content'>
                                                ...
                                                <div class='modal-body'>
                                                    <form id='formModalAceite$id'>
                                                        <div class='mb-3'>
                                                            <label for='observacao_gerente$id' class='form-label'>Observação:</label>
                                                            <textarea class='form-control' id='observacao_gerente$id' name='observacao_gerente' rows='3'></textarea>
                                                        </div>
                                                    </form>
                                                </div>
                                                <div class='modal-footer'>
    ...
    <script type="text/javascript">
        ...
        function submeterAceiteComObservacao(id) {
            // 1. Pega o formulário principal que está na linha da tabela.
            const form = document.getElementById('formAceite' + id);

            // 2. Pega o valor do texto da textarea que está dentro do modal.
            const observacao = document.getElementById('observacao_gerente' + id).value;

            // 3. Cria um campo <input type="hidden"> para a observação.
            //    Isso é necessário para enviar o valor junto com o formulário.
            const observacaoInput = document.createElement('input');
            observacaoInput.type = 'hidden';
            observacaoInput.name = 'observacao_gerente';
            observacaoInput.value = observacao;

            // 4. Cria um campo <input type="hidden"> para o valor do aceite ('1' para 'Sim').
            //    O botão "Não" já faz isso com `name="aceite" value="2"`. Aqui fazemos o mesmo para o "Sim".
            const aceiteInput = document.createElement('input');
            aceiteInput.type = 'hidden';
            aceiteInput.name = 'aceite';
            aceiteInput.value = '1'; // 1 = Aceito

            // 5. Adiciona os novos inputs invisíveis ao formulário.
            form.appendChild(observacaoInput);
            form.appendChild(aceiteInput);

            // 6. Finalmente, submete o formulário.
            form.submit();
        }

        function submeterRecusa(id) {
            const form = document.getElementById('formAceite' + id);

            const aceiteInput = document.createElement('input');
            aceiteInput.type = 'hidden';
            aceiteInput.name = 'aceite';
            aceiteInput.value = '2'; // 2 = Recusado
